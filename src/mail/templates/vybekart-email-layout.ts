...
<body class="vk-body" style="margin:0;padding:0;background-color:${VYBE_THEME.bgLight};font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;">
  <table role="presentation" class="vk-body" width="100%" cellspacing="0" cellpadding="0" style="background-color:${VYBE_THEME.bgLight};padding:28px 12px;">
    <tr><td align="center">
      <table role="presentation" class="vk-card" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:${VYBE_THEME.surfaceLight};border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(11,30,91,0.12);">
        <tr><td style="padding:0;">${hero}</td></tr>
        <tr>
          <td class="vk-content" style="padding:32px 28px;color:${VYBE_THEME.textLight};">
            ${params.bodyHtml}
